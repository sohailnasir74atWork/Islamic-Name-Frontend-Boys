    ...
    <div className={`trending-card ${marginZero}`}>
      <div>
        ...
        <div className='d-flex'>
          ...
          <th className='mobile-hide urdu-cont col-1 p-3'>نام</th>
          <th className='mobile-hide col-4 p-3'>MEANINGS</th>
          ...
          return (
            <div className='col line-color br-10'>
              ...
              <div className='d-flex mr-custom'>
                ...
                <td className='mobile-hide urdu-cont col-1 p-3'>{item.urduName}</td>
                <td className='mobile-hide col-4'>{item.englishMeaning}</td>
                <td className='mobile-hide col-5 urdu-cont justify-content-end p-3'>{item.urduMeaning}</td>
              ...
              <span className='hide m-1 w-50 text-right d-flex flex-column' style={{ fontFamily: "var(--text-font)", fontSize: ".7rem" }}><span style={{color:"var(--color-three)", fontWeight:"500", textAlign:"right"}}>:Urdu Meaning</span><span className='urdu-cont' style={{fontSize:".6rem", lineHeight:"1.5rem"}}> {item.urduMeaning}</span></span>





                 {/* <span className='urdu-cont w-50 pr-1' style={{fontSize:".6rem", lineHeight:"1.5rem"}}> {item.urduMeaning}</span> */}
